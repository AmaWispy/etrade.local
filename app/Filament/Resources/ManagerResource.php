...
class ManagerResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')->required()->maxLength(63),
                Forms\Components\TextInput::make('email')->required()->maxLength(63),
                Forms\Components\TextInput::make('phone')->maxLength(12),
            ]);
    }
