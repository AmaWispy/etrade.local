<form action="" class="flex gap-3 flex-col range-price-container">
    ...
    <div class="flex flex-col gap-2 !items-center">
        <div class="flex w-100 items-center h-10 mb-1">
            <input type="text" class="price-min w-50 border !h-full !rounded-l-lg !m-0 !p-0 !pl-4" value="">
            <input type="text" class="price-max w-50 border !h-full !rounded-r-lg !m-0 !p-0 !pl-4" value="">
        </div>
