...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        */
        ...
        $('.prev-rec').on('click', ()=>{
            $('#cart-recomendate').slick('slickPrev')
        });

        $('.next-rec').on('click', ()=>{
            $('#cart-recomendate').slick('slickNext')
        });

        $('#cart-recomendate').slick({
            slidesToShow: 5,
            slidesToScroll: 5,
            dots:true,
            appendDots: $('#recomendate-dots'),
            arrows:false,
            adaptiveHeight: true,
            responsive: [
                {
        ...
        /* --------------------------------------------------------
            33. Quantity plus minus
        -------------------------------------------------------- */
        $(".cart-plus-minus").prepend('<button data-action="decrement" class="dec qtybutton cursor-pointer">-</button>');
        $(".cart-plus-minus").append('<button data-action="increment" class="inc qtybutton cursor-pointer">+</button>');
        ...
        $('button[data-action="clear-value"]').on('click', function(){
            var $input = $('input[data-action="update-item-quantity"]').focus();
                $input.val(1).trigger('change');
        });
    
        $('input[data-action="update-item-quantity"]').on('input', function() {
